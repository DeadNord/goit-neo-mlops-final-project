...
1. **Встановіть сумісну версію Python.** TensorFlow `2.15.0` підтримує лише Python 3.8–3.11. Використання новіших інтерпретаторів (наприклад, 3.12) призведе до помилки `pip install -r requirements.txt` при встановленні `tensorflow-cpu==2.15.0`. Докладніше про сумісність — у [матриці TensorFlow](https://www.tensorflow.org/install/source#cpu).
